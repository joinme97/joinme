...
public class ActivityMessageDAO {
	...
	public ArrayList<ActivityMessageDTO> receiveActivityMessage(int receiver_activity_id, int sender_user_id, String status,
		...
		try {
			...
			String query = "select message,activity_message_id,reply_user_message_id from activity_message where "
