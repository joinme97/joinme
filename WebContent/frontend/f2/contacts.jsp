...
<%
	...
	if (session.getAttribute("user_id") == null) {
		...
		session.setAttribute("first_name", 70);
...
<nav class="bg-dark text-light w3-sidebar w3-collapse w3-white w3-animate-left" style="z-index:3;width:300px;" id="mySidebar"><br>
  ...
  <div class="w3-bar-block ">
    ...
    <a href="contacts.jsp" class="w3-bar-item w3-button w3-padding w3-blue"><i class="fa fa-users fa-fw"></i>My Contacts</a>
						...
						<div class="col-lg-3 col-md-6">
							<div class="card">
								<div class="card-body">
									...
									<img src="pics/0 (<%=dto.getUser_id()%150%>).jpg" alt=""
										class="img-fluid rounded-circle w-50 mb-3">
									<h3><%=dto.getFirst_name()%></h3>
									<h5 class="text-muted"></h5>
									<p>@<%= dto.getUnique_id()%></p>
									<div class="d-flex flex-row justify-content-center">
										<div class="p-4">
										<input type="hidden" name="friend_id" value=<%=dto.getUser_id()%>>
