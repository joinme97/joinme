...
alADTO=new CreatedActivityListDAO().getAllCreatedActivityListWithuserID((int)session.getAttribute("user_id"));
if(alADTO!=null)
{
						...
						<div class="col-lg-3 col-md-6">
							<div class="card">
								<div class="card-body">
									...
									<h4>members : <%=adao.getAllSelectedActivityListCountWithActivityID(adto.getActivity_id()) %></h4>
									...
									<form action="joined_activity_contact.jsp" method="post">
										...
										<div class="p-4">
										<input type="hidden" name="activity_id" value=<%=adto.getActivity_id() %>>
											<input class="btn btn-dark" type="submit" name="user_list" value="members" >
										</div>
									</div>
									</form>
								</div>
