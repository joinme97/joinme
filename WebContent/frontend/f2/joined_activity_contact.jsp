<!DOCTYPE html>
<%@page import="com.sjl.joinme.selected_activity_list.SelectedActivityListDTO"%>
...
<nav class="bg-dark text-light w3-sidebar w3-collapse w3-white w3-animate-left" style="z-index:3;width:300px;" id="mySidebar"><br>
  <div class="w3-container w3-row">
    ...
    <div class="w3-col s8 w3-bar">
      <span>WelcomeWelcome,<br><%=session.getAttribute("first_name") %></span><br>
...
ArrayList<SelectedActivityListDTO> selected_activity_list_contact=new ArrayList(); 
UserDTO udto= new UserDTO();
 selected_activity_list_contact=new SelectedActivityListDAO().getAllSelectedActivityListWithActivityID(Integer.parseInt(request.getParameter("activity_id")));
UserDAO dao=new UserDAO();
if(selected_activity_list_contact!=null){
for(SelectedActivityListDTO sdto:selected_activity_list_contact){
	udto=dao.getUser(sdto.getUser_id());
	%>
						...
						<div class="col-lg-3 col-md-6">
							<div class="card">
								<div class="card-body">
									...
									<img src="pics/0 (<%=udto.getUser_id()%150%>).jpg" alt=""
										class="img-fluid rounded-circle w-50 mb-3">
									<h3><%=udto.getFirst_name()%></h3>
									<h5 class="text-muted"></h5>
									<p>@<%= udto.getUnique_id()%></p>
									<p>joined date@<%= sdto.getCreated_datetime()%></p>
