			...
			<div class="login-form">
				...
				<form action="index.jsp" method="post">
					<div class="sign-up-htm">
						<div class="group">
							<label for="user" class="label"><br>First Name</label> 
							<input id="user" name="first_name" type="text" class="input" required>
						</div>
						<div class="group">
						...
						<div class="group">
							...
							<input id="user" type="text" name="unique_id" class="input" required>
						</div>
